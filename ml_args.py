...
def parse_args():
    parser = argparse.ArgumentParser(description='Unsupervised Game Segmentation Training')
    ...
    # Logging and Saving
    parser.add_argument('-p', '--print-freq', default=5, type=int, help='print frequency')
    ...
    parser.add_argument('-cp', '--checkpoint', default='', help='resume from checkpoint')
